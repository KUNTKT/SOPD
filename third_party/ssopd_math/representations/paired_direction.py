...
def build_directions_from_records(
    ...
    *,
    ...
    del position_key  # extraction site fixed upstream in hidden records
    ...
    if variant == "task_balanced_paired":
        v_cap = compute_macro_direction(per_problem)
